...
<template>
    ...
    <Head>
        <title>{{ t('admin.edit_user') }}</title>
    </Head>

    <div class="max-w-lg mx-auto mt-10 p-6 bg-white rounded shadow">
        <h1 class="text-2xl font-bold mb-6">{{ t('admin.edit_user') }}</h1>
        ...
        <form @submit.prevent="submit" novalidate>
            ...
            <div class="mb-4">
                <label class="block mb-1 font-semibold" for="password">{{ t('admin.password_optional') }}</label>
            ...
            <div class="mb-4">
                <label class="block mb-1 font-semibold" for="password_confirmation">{{ t('admin.password_confirmation')
                    }}</label>
